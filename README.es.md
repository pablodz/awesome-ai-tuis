...
| 13 | [**Lanes**](https://github.com/lanes-sh/app) | 242 | — | Centro de control para agentes de código en paralelo. | 🎛 Agentes paralelos · 🖥 Orquestación · 🔌 Multi-proveedor · 📊 Dashboard |
| 14 | [**LlamaTerm**](https://github.com/adammpkins/llama-terminal-completion) | 195 | Go | Asistente de terminal IA compatible con cualquier API OpenAI. | 🦙 Soporte Ollama/LM Studio · 💬 Chat TUI interactivo · ⚡ Streaming · 🔌 Compatible OpenAI |
| 15 | [**Sidekick**](https://github.com/cesarandreslopez/sidekick-agent-hub) | 69 | TypeScript | Asistente multi-proveedor y monitor de sesiones con dashboard TUI. | 📊 Tracking de tokens/coste · 🔄 Multi-cuenta · 👁 Monitor de sesiones · 🖥 VS Code + terminal |
| 16 | [**JrDev**](https://github.com/presstab/jrdev) | 67 | Python | Asistente de desarrollo IA gratuito y open source para la terminal. | 🧠 Generación de código · 📂 Contexto de proyecto · 🌳 Operaciones Git · 🖥 Híbrido CLI/TUI |
| 17 | [**CodeAuto**](https://github.com/Yulin-Bi/CodeAuto) | 45 | Java | Asistente de programación IA inspirado en Claude Code y Minicode. | ☕ Java · 🛠 MCP · 🧩 Sistema de skills · 🖥 TUI de terminal |
| 18 | [**Orchestra**](https://github.com/humanunsupervised/orchestra) | 28 | Rust | Asistentes de código IA en paralelo en la terminal. | 🦀 Rust · 🔀 Agentes paralelos · 🪟 Integración Tmux · ⚡ TUI rápido |
| 19 | [**Raijin**](https://github.com/francescoalemanno/raijin-mono) | 26 | Go | Asistente de terminal IA con soporte multi-proveedor LLM. | ⚡ Go · 🔌 Multi-proveedor · 🛠 Herramientas integradas · 📚 Skills para flujos |
| 20 | [**MatrixClaw**](https://github.com/Suren878/matrixclaw) | 26 | Go | Asistente IA local siempre activo y agente de código. | 🏠 Local-first · 📱 Telegram TUI · 🛠 MCP · 📅 Tareas programadas · 🧠 Sub-agentes |
| 21 | [**Spettro**](https://github.com/cesp99/spettro) | 23 | Go | Asistente multi-agente con planificación y testing. | 🤖 Multi-agente · 📋 Plan/Código/Test · 🎛 Selección de modelo · 🖥 Bubble Tea TUI |
| 22 | [**Crustly**](https://github.com/jyjeanne/crustly) | 18 | Rust | Asistente TUI ultrarrápido con privacidad primero. | 🦀 Rust · 🔒 LLMs locales · 🪶 Eficiente en memoria · 🏠 Privacidad primero |
| 23 | [**Rust TUI Coder**](https://github.com/Ammar-Alnagar/Rust-TUI-Coder) | 12 | Rust | Potente asistente de terminal con TUI interactivo. | 🦀 Rust · 💬 Chat · ⚡ Ejecución de código · 📁 Manipulación de archivos · 🎨 UI bonita |
| 24 | [**Bitcode**](https://github.com/sazid/bitcode) | 7 | Go | Asistente de código con bucle agéntico y TUI. | 🔁 Bucle agéntico · 🛠 Llamadas a herramientas · 🛡 Guardrails · ⏰ Recordatorios |
| 25 | [**OpenZeroCode**](https://github.com/arborlogic/openzerocode) | 6 | TypeScript | Asistente TUI local-first adaptado de OpenCode. | 🏠 Local-first · ☁ Sin dependencias cloud · 🔌 Multi-proveedor · 🧠 Memoria de trabajo |
| 26 | [**Agentop**](https://github.com/dadwadw233/agentop) | 5 | Python | Interfaz TUI para monitorizar agentes de IA — htop para agentes. | 📊 Monitor de agentes · 🔍 Claude Code/Codex/Antigravity · 📈 Estadísticas en vivo |
| 27 | [**PolyCode**](https://github.com/izzoa/polycode) | 3 | Go | Asistente de código con consenso multi-modelo para la terminal. | 🤝 Consenso de modelos · 🔌 Multi-modelo · 🖥 TUI de terminal |
| 28 | [**Talon**](https://github.com/ChxisB/Talon) | 2 | Go | Asistente IA con soporte multi-proveedor y dashboard web. | 🖥 Dashboard web · 📸 Análisis de capturas · 🔌 Multi-proveedor · 🎛 TUI |
