...
> Ordered by GitHub stars (descending). Stars updated June 2025.

| # | Name | ⭐ Stars | Language | Description | Key Features |
|---|------|---------|----------|-------------|--------------|
| 1 | [**OpenCode**](https://github.com/anomalyco/opencode) | 178k | TypeScript | The open source coding agent. | 🧠 Plan/Implement modes · 🎨 TUI-first · 🔌 Multi-provider · 📝 Inline diff editing · 🗂 File-aware context · ⚡ Terminal-native |
| 2 | [**Claude Code**](https://github.com/anthropics/claude-code) | 134k | Python | Anthropic's agentic coding tool that lives in your terminal. | 🧠 Agentic loop · 📚 Codebase understanding · 🌳 Git workflows · 🛠 MCP tools · 🤝 Sub-agents · 💬 Natural language |
| 3 | [**Gemini CLI**](https://github.com/google-gemini/gemini-cli) | 105k | TypeScript | Google's AI agent with Gemini in your terminal. | 🌟 Gemini powered · 🛠 MCP client/server · 🔓 Open source · 🧩 Multi-tool orchestration · ⚡ Fast startup |
| 4 | [**Codex**](https://github.com/openai/codex) | 93k | Rust | OpenAI's lightweight coding agent for the terminal. | 🪶 Lightweight binary · 🦀 Rust-powered · 🔌 OpenAI models · 🔒 Sandboxed exec · ⚡ Fast & snappy |
| 5 | [**Open Interpreter**](https://github.com/openinterpreter/openinterpreter) | 64k | Rust | Coding agent for open models (DeepSeek, Kimi, Qwen). | 🧠 ReAct agent · 🦀 Rust · 🏠 Local-first · 🌍 Open models · 🛠 Rich tool set |
| 6 | [**Aider**](https://github.com/Aider-AI/aider) | 46k | Python | AI pair programming in your terminal. | 🤝 Pair programming · 🧠 Multi-model (GPT, Claude, Gemini) · 🌳 Git-aware diffs · 🗺 Map-reduce context · 🎙 Voice coding |
| 7 | [**Copilot CLI**](https://github.com/github/copilot-cli) | 10k | Shell | GitHub Copilot agent in your terminal. | 🐙 GitHub native · 💻 Shell commands · 📝 Code explanations · 🔗 `gh` CLI integration |
...
| 9 | [**Claude Codex Bridge**](https://github.com/SeemSeam/claude_codex_bridge) | 3k | Python | Visible multi-agent CLI workspace for mixing AI coding agents. | 🤖 Multi-agent · 🖥 Tmux workspace · 🔄 Agent mixing · 👁 Visible execution |
...
Want to contribute? Copy the row below and [open a PR](CONTRIBUTING.md):
...
**Guidelines:**
- Insert in the correct position (sorted by ⭐ stars descending).
- Keep the description under one line (~100 chars).
- List up to 6 key features using `·` as separator.
- Use emoji for each feature for visual scannability.
- Stars should be fetched from the GitHub API.
